...
create_database_query = "CREATE DATABASE lista"
#create_database(connection, create_database_query)


#serve per creare le tabelle
...
#mi permette di creare una lista di dati presi dal database
...
#serve per stampare in maniera piu capibilei la tabella attraverso pandas
from_db = []
...
from_db = []  # Inizializza la lista dei risultati
...
if results4:
    print("Almeno un insegnante con ID maggiore di 5 è stato trovato:")
    for result in results4:
        print(result)
else:
    print("Nessun insegnante con ID maggiore di 5 è stato trovato.")